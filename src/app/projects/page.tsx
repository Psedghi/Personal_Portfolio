...
const PROJECTS = [
  ...
  },
  {
    ...
    tags: ["Product Design", "QUEST Honors", "Sustainability"],
    blurb:
                ...
                >
                  ...
                  <div className="w-full md:w-1/2">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-6 inline-flex items-center gap-2 font-mono text-sm uppercase tracking-[0.15em] text-cream transition-colors duration-300 hover:text-rust-bright"
                    >
                      View project
